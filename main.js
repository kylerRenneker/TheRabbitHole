...
function renderVideoHtml(){
  $('#video').html(`<embed src="${videoURL + id.newId}" wmode="transparent" type="application/x-shockwave-flash" width="420" height="315" allowfullscreen="true" title="Adobe Flash Player">`);
}  
